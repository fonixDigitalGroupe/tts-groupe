<div x-data="{ show: false }" 
    ...
    <a href="https://wa.me/221774163535" target="_blank" rel="noopener noreferrer" 
       class="flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:bg-[#20ba5a] transition-all transform hover:scale-110 group relative">
        <!-- Pulse effect -->
        <span class="absolute inset-0 rounded-full bg-[#25D366] opacity-75 animate-ping group-hover:pause"></span>
