    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative overflow-hidden text-center">
            ...
            <div class="relative z-10 flex flex-col items-center">
                <!-- Icon -->
                <div class="mb-8">
                    <div class="w-20 h-20 bg-blue-50 text-[#00A3A2] rounded-3xl flex items-center justify-center shadow-sm">
                ...
                <!-- CTA Button -->
                <a href="#" class="inline-flex items-center px-12 py-5 bg-[#00A3A2] text-white font-black rounded-full transition-all shadow-lg shadow-[#00A3A2]/20">
