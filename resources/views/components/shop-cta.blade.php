        ...
        <div class="relative overflow-hidden bg-[#9333ea] rounded-[2rem] p-8 md:p-10 text-center text-white shadow-2xl">
            ...
            <div class="relative z-10 flex flex-col items-center">
                ...
                <div class="flex flex-wrap justify-center gap-3 mb-6">
                    <div class="flex items-center bg-white rounded-full px-5 py-1.5 text-[#9333ea] font-semibold text-xs md:text-sm shadow-sm">
                ...
                <!-- CTA Button -->
                <a href="#" class="inline-flex items-center px-7 py-3.5 bg-[#f97316] hover:bg-[#ea580c] text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg shadow-orange-600/30">
