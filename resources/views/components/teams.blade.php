<section class="py-24 bg-white relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20">
            <h2 class="text-2xl md:text-4xl font-semibold text-blue-950 mb-8 tracking-tight">Nos équipes <span class="text-[#00A3A2]">en action</span></h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Image 1 -->
            <div class="relative group overflow-hidden rounded-[2rem] shadow-sm aspect-[4/3] bg-gray-100 border border-gray-100">
                ...
                <!-- Badge -->
                <div class="absolute top-6 left-6 z-10 px-3 py-1 bg-[#00A3A2]/90 backdrop-blur-md text-white text-[10px] font-black uppercase tracking-widest rounded-full">
                    Terrain
                </div>
