    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                Découvrez notre expertise sur le terrain à travers les interventions de nos techniciens qualifiés.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="relative group overflow-hidden rounded-2xl shadow-lg aspect-square">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                    <h4 class="text-white font-bold text-xl">Intervention Réseau</h4>
                    <p class="text-gray-200 text-sm">Maintenance sur boîtier de distribution de rue.</p>
                </div>
            </div>
            ...
            <div class="relative group overflow-hidden rounded-2xl shadow-lg aspect-square">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                    <h4 class="text-white font-bold text-xl">Raccordement Aérien</h4>
                    <p class="text-gray-200 text-sm">Installation de câbles fibre optique sur appuis.</p>
                </div>
            </div>
            ...
            <div class="relative group overflow-hidden rounded-2xl shadow-lg aspect-square">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                    <h4 class="text-white font-bold text-xl">Soudure de Précision</h4>
                    <p class="text-gray-200 text-sm">Fusion par arc électrique en atelier mobile certifié.</p>
                </div>
            </div>
        </div>
    </div>
