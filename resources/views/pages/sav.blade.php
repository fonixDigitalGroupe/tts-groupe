    ...
    <section class="py-24 bg-white relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20">
                <h2 class="text-2xl md:text-4xl font-semibold text-blue-950 mb-8 tracking-tight">Maintenance & <span class="text-[#00A3A2]">Correction</span></h2>
                <p class="text-gray-500 max-w-3xl mx-auto text-lg leading-relaxed font-medium">
                    Le service après-vente de <span class="text-blue-950 font-bold border-b-2 border-[#00A3A2]/30">TTS GROUPE</span> intervient rapidement pour diagnostiquer et résoudre tout dysfonctionnement sur vos réseaux fibre optique.
                </p>
            </div>
                ...
                <div class="relative bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden">
                    <div class="flex items-center space-x-6 mb-10">
                        ...
                        <div>
                            ...
                            <span class="px-3 py-1 bg-[#f0faf9] text-[#008a89] text-[10px] font-black uppercase tracking-widest rounded-full">Intervention Rapide</span>
                        </div>
                    </div>
