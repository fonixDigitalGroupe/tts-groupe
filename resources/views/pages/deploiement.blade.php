...
@section('content')
    ...
    <div class="bg-white border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 py-8">
            <a href="{{ url('/') }}" class="inline-flex items-center">
                ...
                <div class="text-left">
                    <h2 class="text-2xl font-black text-blue-950 tracking-tight">Déploiement réseau</h2>
    ...
    <section class="bg-blue-50 py-16 relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 relative z-10 text-center">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-2xl md:text-4xl font-black tracking-tight mb-6 text-blue-950">Déploiement réseau</h1>
    ...
    <section class="py-12 bg-white relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <!-- 1. Infrastructure FTTH (Keeping as a specific expertise card) -->
                <div class="relative bg-white p-10 border border-gray-100 shadow-sm overflow-hidden">
                    <div class="flex items-center space-x-6 mb-10">
                        <div class="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center text-[#00A3A2]">
    ...
    <section class="py-16 bg-white relative">
        <div class="max-w-7xl mx-auto px-4 relative z-10 text-center">
            <h3 class="text-2xl md:text-4xl font-black text-blue-950 mb-6 tracking-tight">Un projet de déploiement d'envergure ?</h3>
