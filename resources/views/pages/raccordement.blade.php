...
@section('content')
    ...
    <div class="bg-white border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 py-8">
            <a href="{{ url('/') }}" class="inline-flex items-center">
                ...
                <div class="text-left">
                    <h2 class="text-2xl font-black text-blue-950 tracking-tight">Raccordement</h2>
    ...
    <section class="bg-blue-50 py-16 relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 relative z-10 text-center">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-2xl md:text-4xl font-black tracking-tight mb-6 text-blue-950">Raccordement FTTH</h1>
    ...
    <section class="py-16 bg-white relative">
        <div class="max-w-7xl mx-auto px-4 relative z-10 text-center">
            <h3 class="text-2xl md:text-4xl font-black text-blue-950 mb-6 tracking-tight">Une demande de raccordement fibre ?</h3>
