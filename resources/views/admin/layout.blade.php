...
<div class="flex h-full overflow-hidden" x-data="{ sidebarOpen: true, mobileSidebarOpen: false }">
    ...
    <aside class="sidebar flex flex-col shrink-0 z-50 relative shadow-2xl transition-transform duration-300 ease-in-out"
        ...
        <nav class="flex-1 py-8 overflow-y-auto px-2">
            <div class="px-6 mb-4 text-[11px] font-bold uppercase text-slate-500 tracking-[0.2em]">Contenu du site</div>

            <a href="{{ route('admin.banner') }}" class="nav-link {{ request()->routeIs('admin.banner') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v10a1 1 0 01-1 1H5a1 1 0 01-1-1V5z M4 15l4-4a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14"></path></svg>
                Bannière
            </a>
            ...
            <div class="px-6 mt-6 mb-4 text-[11px] font-bold uppercase text-slate-500 tracking-[0.2em]">Administration</div>
