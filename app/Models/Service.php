...
class Service extends Model
{
    ...
    /**
     * Jeu d'icônes prédéfinies : clé => [libellé admin, contenu SVG (paths)].
     * Le SVG est du contenu de confiance (défini ici, pas saisi par l'utilisateur).
     */
    public const ICONS = [
        'etudes' => [
            'label' => "Bureau d'études",
            'svg'   => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />',
        ],
        'fibre' => [
            'label' => 'Fibre / Réseau',
            'svg'   => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.141 0M1.343 8.577c5.857-5.858 15.355-5.858 21.213 0" />',
        ],
        'sav' => [
            'label' => 'SAV / Réglages',
        ...
        'globe' => [
            'label' => 'Déploiement / Monde',
            'svg'   => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />',
        ],
        'bolt' => [
            'label' => 'Énergie / Rapidité',
            'svg'   => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />',
        ],
        'shield' => [
            'label' => 'Sécurité / Qualité',
    ...
    /**
     * Contenu SVG de l'icône du service (fallback sur la première icône si clé inconnue).
     */
    public function iconSvg(): string
    {
        return self::ICONS[$this->icon]['svg'] ?? reset(self::ICONS)['svg'];
    }
