...
{
    /**
     * Jeu d'icônes pour les sections « Moyens » et « Engagements » de la page À propos.
     * clé => [libellé admin, contenu SVG (paths)].
     */
    public const MAP = [
        'users' => [
            'label' => 'Personnes / Équipe',
        ...
        'truck' => [
            'label' => 'Véhicules',
            'svg'   => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4-4m-4 4l4 4" />',
        ],
        'wrench' => [
    ...
    {
        return self::MAP[$key]['svg'] ?? reset(self::MAP)['svg'];
    }
}
